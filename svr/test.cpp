...
/*----------------上面是序列化，下面是反序列化-----------------------*/
    ...
    for (int j = 0; j < deserializedStudent.phones_size(); j++){
    	const tutorial::Student::PhoneNumber& phone_number = deserializedStudent.phones(j);
